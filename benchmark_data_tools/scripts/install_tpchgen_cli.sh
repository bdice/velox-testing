...
# Only the Rust builder stage is required because this script copies the
# tpchgen-cli binary out of the image. Skip later Python stages and their
# unrelated registry dependencies.
